...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.print("\nAfter scaling:\n");
		System.out.println("Rect1: " + myRect1.width + ", " + myRect1.height);
		System.out.println("Rect2: " + myRect2.width + ", " + myRect2.height);
		System.out.println("Rect3: " + myRect3.width + ", " + myRect3.height);
